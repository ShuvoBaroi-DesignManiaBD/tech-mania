      ...
      >
        ...
        <div className="flex justify-between items-center pt-4 px-20">
          <Button
            ...
            onClick={handlePopup}
            icon={
              <Image src="/video.png" alt="video_icon" width={30} height={30} />
            }
          >
            Live video
          </Button>
          <Button
            ...
            onClick={handlePopup}
            icon={
              <Image src="/image.png" alt="image_icon" width={30} height={30} />
            }
          >
            Photo/Video
          </Button>
          <Button
            ...
            onClick={handlePopup}
            icon={
              <Image src="/emoji.png" alt="emoji_icon" width={30} height={30} />
            }
          >
            Feeling/Activity
          </Button>
