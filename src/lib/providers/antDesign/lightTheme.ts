...
export const lightTheme = {
  ...
  token: {
    ...
    colorPrimaryBg: "#E0F2FE", // Light background for primary buttons
    colorPrimaryHover: "#2563EB", // Hover state for primary buttons
    colorPrimaryTextHover: "#FFFFFF", // Hover text color for primary buttons
    colorPrimaryText: "#1E3A8A", // Dark text color for primary buttons
    ...
    colorBorder: "#D1D5DB", // Border color for dividers and components
